...
const AuctionDetail = () => {
    ...
    const canFinalize = auction?.blockchain?.isActive && !auction?.blockchain?.isFinalized && auction?.remaining_time === 0;
    const isEnded = auction?.status === 'ended' || auction?.blockchain?.isFinalized ||
        (auction?.blockchain?.endTime && auction.blockchain.endTime <= Math.floor(Date.now() / 1000));
                ...
                <div className="auction-main">
                    ...
                    <div className="auction-info-card">
                        ...
                        {canFinalize && (
                            ...
                            >
                                {isFinalizing ? 'Memproses...' : 'Finalisasi Lelang'}
                            </button>
                        )}
                    </div>
                </div>
